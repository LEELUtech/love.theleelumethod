		...
		<div className="relative">
			...
			<Section sectionClasses="!pb-16 md:!pb-0">
				<div className="max-w-[800px] mx-auto text-center px-2">
					...
					<h2 className="font-thin font-canela text-brand-deep mb-6 text-[60px]/[126%]">
						THE SYNTHESIS
					</h2>

					<p className="font-canela text-brand-black mb-6 text-[32px]/[130%]">
						Filling the Gaps
					</p>
					...
					<h3 className="font-canela text-brand-black mb-4 text-[32px]">
						Fulfillment.
					</h3>
