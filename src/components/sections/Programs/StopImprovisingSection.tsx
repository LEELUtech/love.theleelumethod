	...
	return (
		<section className="bg-brand-white pt-[72px] lg:pt-[160px]">
			<div className="container">
				<div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-[104px] items-start">
					{/* RIGHT: image block (MOBILE/TABLET FIRST) */}
					<div className="order-1 lg:order-2 relative w-full max-w-[520px] mx-auto lg:mx-0 lg:ml-auto justify-items-center">
						{/* Tall rounded image */}
						<div className="relative xs:w-[360px] xs:h-[459px] lg:w-[496px] lg:h-[833px] md:w-[696px] md:h-[833px] overflow-hidden rounded-[60px] lg:rounded-[100px]">
							<Image
					...
					<div className="order-2 lg:order-1 max-w-[560px] mt-[34px] lg:mt-0">
						...
						<div className="mt-[30px] font-normal space-y-5 font-lato text-[#5A5757] text-body md:text-body leading-[24px] md:leading-[26px]">
							<p>
								...
								<br />
								But when it comes to the high-stakes architecture of your
								relationships, you are operating on instinct alone.
							</p>

							<p className="text-brand-primary font-canela text-[20px]">
								And your instinct is sabotaging you.
							</p>
							...
							<p>
								Your instincts are not random. They are code, written by your
								earliest experiences, your unhealed wounds, and the men who shaped
							...
							<p className="text-[#5A5757]">
								The Relationship Protocol is not a collection of dating tips.
							</p>

							<p>
								It is an audit of your relational history, followed by a System
								Reset — a 12-module deprogramming sequence designed to identify
								the corrupted script running in your subconscious, delete the
								glitch, and install a new operating system for connection.
							</p>
						</div>
					</div>
				</div>
