		...
		<section className="relative lg:py-[131px] pt-[54px] bg-brand-white overflow-hidden">
			<div className="container px-4 relative z-10">
				...
				>
					...
					<div className="font-light transition text-[24px] md:text-[22px] lg:text-[24px] leading-[100%] font-canela flex items-center gap-2 md:gap-2.5 lg:gap-3 text-brand-black  justify-center md:justify-start mt-[73px]">
					...
					<p
						...
						"
					>
						DON&apos;T JUST READ THE MAP. LET ME NAVIGATE.
					</p>
					...
					<p
						...
						"
					>
						You have the will to change, but you have blind spots you cannot
						see. I will find the root cause in your code and give you the
						precise correction.
					</p>
