...
export default function MechanicsDeliverablesSection() {
  return (
    <Section backgroundImage={'https://firebasestorage.googleapis.com/v0/b/leelu-tech.firebasestorage.app/o/love.theleelumethod%2Fbg%2Fmechanics_section_bg.png?alt=media'} backgroundPosition='bottom'>
