          ...
          <Flex>
            ...
            <div className='w-full grid grid-cols-1 gap-10 lg:gap-6 justify-center justify-items-stretch lg:grid-cols-3 lg:justify-items-center'>
              {tiers.map((tier) => (
                <div
                  key={tier.title}
                  className={`relative flex w-full flex-col rounded-[32px] bg-white px-6 py-8 lg:px-0 shadow-lg`}
                >
                  {tier.popular && (
                  ...
                  <h3 className='mx-0 text-[42px]/[126%] mb-[10px] max-w-[200px] lg:mx-auto font-canela font-thin lg:text-[36px] text-brand-black lg:text-center xs:text-left'>
                    {tier.title}
                  </h3>

                  <ul className='mt-8 flex flex-col gap-0 flex-1 px-0 lg:px-4 4xl:px-8 font-lato text-[18px]/[120%] text-brand-gray'>
                    {tier.features.map((feature, i) => {
                      ...
                      return (
                        <li
                          key={i}
                          className={`flex flex-col lg:items-start lg:justify-center h-auto py-4 lg:py-0 lg:h-[90px] border-b border-[#C6ABB3] last:border-none ${!isExist ? 'lg:justify-center lg:items-center' : ''}`}
                        >
                  ...
                  <div className='mt-10 text-left lg:text-center px-0 lg:px-4'>
