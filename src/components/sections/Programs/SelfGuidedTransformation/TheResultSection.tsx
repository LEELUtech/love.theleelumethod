		...
		<section className="relative overflow-hidden bg-white">
			...
			>
				...
				<p
					...
					"
				>
					You stop operating on instinct (which is traumatized) and start
					operating on intelligence. You will know exactly why your past
					relationships failed and have the specific behavioral blueprint to
					build the next one on solid ground.
				</p>
			</div>
		</section>
	);
