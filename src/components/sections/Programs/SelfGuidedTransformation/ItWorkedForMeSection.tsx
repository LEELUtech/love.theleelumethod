      ...
      >
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 lg:gap-10 items-center'>
          ...
          <div className='lg:max-w-[492px] lg:order-1 order-2 md:mx-auto lg:mx-0'>
            ...
            <p className='mb-6 font-lato text-[#757986] text-[17px]/[26px] md:text-[18px] '>
              Before we got serious, I got analytical. I ran our numbers to ensure our compatibility was structural, not
              just chemical. The result? Four years of excitement, fulfillment, and peace.
            </p>

            <p className='mb-6 font-canela font-light text-brand-deep text-[32px]/[100%]'>
              I didn&apos;t waste a decade finding the
              <br className='hidden lg:block' /> right one—I engineered it.
            </p>

            <Button variant='primary' className='w-full lg:w-[70%] xs:text-[12px] mt-[32px]'>
              BEGIN THE PROTOCOL
            </Button>
          </div>
