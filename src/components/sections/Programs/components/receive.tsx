		...
		<div className="text-center py-4 lg:py-0">
			<Flex gap={35} component="article" className="mb-7">
				...
				<div className="text-brand-deep text-center mx-auto md:mx-0 lg:text-left">
					<h2 className="text-[48px]/[126%] font-canela font-thin lg:text-[60px]">
						{receiveTitle}
					</h2>
					<p className="font-lato lg:mt-2 mt-6 max-w-[552px] text-body">
						{receiveSubtitle}
					</p>
				</div>
			</Flex>
			...
			>
				<Flex
					vertical
					className="flex-1 mt-[115px] flex-col items-cente lg:items-start"
				>
					<h3
					...
					{description && (
						<h6 className="text-[17px]/[26px] text-left font-lato text-brand-gray mb-4 md:mb-9">
							{description}
						</h6>
					)}
					<ArrowList list={list} />
