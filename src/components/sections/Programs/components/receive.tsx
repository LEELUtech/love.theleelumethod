...
export const ProgramsReceive = (props: Props) => {
  ...
  return (
    <div className='text-center'>
      <Flex gap={35} component='article' className='mb-[35px]'>
        ...
        <div className='text-brand-deep text-left'>
          <h2 className='text-[48px]/[100%]  font-canela font-thin lg:text-[60px]'>{receiveTitle}</h2>
      ...
      <Flex
        component='article'
        className='flex-col-reverse lg:flex-row lg:space-between  lg:gap-[90px] xl:gap-[110px] 2xl:gap-[130px]'
      >
        <Flex vertical className='flex-1 mt-[115px] flex-col items-center lg:items-start gap-16'>
          <h3
          ...
          {description && (
            <h6 className='text-[17px]/[26px] text-left font-lato text-brand-gray mb-9'>{description}</h6>
          )}
          <ArrowList list={list} />
          {subtitle && (
            <p className='text-[32px]/[100%] mt-[48px] text-left font-canela font-light'>
