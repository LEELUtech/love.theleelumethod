			...
			<div className="container px-4 relative z-10">
				...
				>
					...
					<div className="relative">
						...
						<div
							className="
								...
								bottom-[-28px]
								w-[74px] h-[102px]
								md:w-[74px] md:h-[102px]
								lg:w-[74px] lg:h-[102px]
								rounded-[999px]
								overflow-hidden bg-[#EB4F68] before:absolute before:inset-0 before:bg-[url('/icons/noise.png')] before:opacity-15 before:mix-blend-overlay
						...
						>
							<RotateOnView 
								...
								amount={0.4} 
								ease="easeOut"
								className="relative w-[46px] h-[45px] md:w-[46px] md:h-[45px] lg:w-[46px] lg:h-[45px]"
							>
								<Image
									src="/leelu_logo.svg"
									alt=""
					...
					<p
						...
						"
					>
						IMMEDIATE INTERVENTION. PERMANENT RECONSTRUCTION.
					</p>
					...
					<p
						...
						"
					>
						For the woman who needs the problem solved immediately. Real-time
						access. Deep-tissue deprogramming.
					</p>
					...
					<Button
						variant="primary"
						size="md"
						className="w-full lg:w-[35%] xs:text-[12px] mt-[32px] lg:order-3"
					trackingData={{
						cta_name: "enroll_now",
						cta_text: "ENROLL NOW",
						cta_target_url: null,
						cta_location: "vip_hero",
					}}
					>
						ENROLL NOW
					</Button>
