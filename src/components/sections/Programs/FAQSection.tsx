				...
				<div className="mt-[40px] md:mt-[48px] lg:mt-[56px] space-y-[16px] md:space-y-[24px] lg:space-y-[16px]">
					{FAQ.map((item) => (
						<div key={item.q} className="py-[24px] md:py-[28px] lg:py-[24px]">
							<h3 className="font-canela font-normal text-brand-black text-[20px] md:text-[21px] lg:text-[22px] leading-[140%] md:leading-[150%]">
								{item.q}
							</h3>

							<p className="mt-3 font-lato font-medium text-[#5A5757] text-[14px] md:text-[16px] lg:text-body leading-[26px] md:leading-[28px]">
								{item.a}
							</p>
						</div>
					))}
