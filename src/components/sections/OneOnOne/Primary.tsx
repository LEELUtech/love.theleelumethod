...
export const Primary = () => {
  ...
  return (
    <section className='max-w-[1600px] px-4 sm:px-6 mx-auto py-[112px] md:px-6 2xl:px-[180px]'>
      <div className='flex flex-col gap-[40px] justify-center md:flex-row lg:gap-[90px] 2xl:gap-[130px]'>
        <div className='flex-1 md:max-w-[494px] text-brand-deep order-2 md:order-1'>
          <h3 className='text-[48px]/[100%] lg:text-h1  font-thin leading-[100%] mb-6 font-canela'>{content.title}</h3>
          <h4 className='text-h2 text-deep font-light mb-8 font-canela'>{content.subtitle}</h4>
          <p className='text-body text-deep mb-6 font-lato'>{content.description}</p>
          <Button variant='primary' size='md' className='w-full px-[8px] md:w-[65%] lg:py-[12px]' href='#'>
            BOOK YOUR SESSION
          </Button>
        </div>

        <div className='flex-1 order-1 md:order-2 relative'>
          <div className='max-w-full md:max-w-[600px] rounded-[100px] md:rounded-[60px] overflow-hidden '>
