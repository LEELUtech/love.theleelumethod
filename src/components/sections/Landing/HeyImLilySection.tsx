...
export default function HeyImLilySection() {
  return (
          ...
          <div className='flex flex-col'>
            ...
            <div className='space-y-8 md:space-y-8 lg:space-y-8 mb-8 md:mb-8 lg:mb-10'>
              <p className='text-[#5A5757] font-lato text-[17px] md:text-[17px] lg:text-body leading-[24px] md:leading-[26px] lg:leading-[28px]'>
                I am Lily Chystofat. I didn&apos;t learn about relationships from a magazine. I learned to decode human
                behavior in high-stakes environments—running elite HR firms and navigating geopolitical crises where
                &quot;reading people&quot; was a matter of survival.
              </p>
              ...
              <p className='text-[#5A5757] font-lato text-[17px] md:text-[17px] lg:text-body leading-[24px] md:leading-[26px] lg:leading-[28px]'>
                I realized that love follows a pattern. Heartbreak follows a pattern. And if it’s a pattern, it can be
                hacked.
              </p>
	...
	'
            ...
            <Button variant='dark' size='md' className='w-full lg:w-[55%] xs:text-[12px]'>
              YES, I&apos;M IN
            </Button>
          </div>
        </div>
