...
function TierRow({
	...
	return (
		<div
			className={`py-[20px] ${last ? "border-b border-[#C6ABB3]" : "border-b border-[#C6ABB3]"} ${className}`}
		>
			<p className="font-lato font-normal text-[18px] text-[#41444E] leading-[150%]">
				{text}
			</p>
		</div>
	);
...
export default function RelationshipProtocolTiers() {
	return (
		<div className="mt-[50px] lg:mt-[120px]">
			<h2 className="font-thin text-[48px] lg:text-[80px] leading-[100%] font-canela text-brand-deep text-center">
				...
				<div className="mt-[40px] lg:mt-[60px] w-full">
					<div className="grid grid-cols-1 lg:grid-cols-[240px_1fr_1fr_1fr] gap-5 lg:gap-6 items-start">
						...
						<div className="hidden lg:block pt-[55px]">
							<p className="font-canela font-light text-[27px] text-brand-black mb-[72px]">
								Feature
							</p>
						...
						<div className="rounded-[32px] bg-brand-white shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] px-7 lg:px-8 pb-7 min-h-[966px] pt-[46px] flex flex-col">
							<h3 className="font-canela font-thin text-[36px] text-brand-black text-center leading-[100%]">
								The <br /> Essentials
							</h3>
							...
							<p className="mt-6 font-canela font-light text-[32px] text-brand-deep text-center">
								$697
							</p>
						...
						<div className="relative rounded-[32px] bg-brand-white shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] px-7 lg:px-8 pb-7 min-h-[966px] pt-[46px] flex flex-col">
							...
							<div className="mt-8 space-y-0">
								...
								<TierRow
									text="Same as Essentials"
									className="pt-[31px] pb-[34px]"
								/>
						...
						<div className="relative rounded-[32px] bg-brand-white shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] px-7 lg:px-8 pb-7 min-h-[966px] pt-[46px] flex flex-col">
							...
							<div className="mt-8 space-y-0">
								...
								<TierRow
									text="(4) Sessions: 90min + (3) 60min"
									className="pt-[7px] pb-[7px]"
								/>
								<TierRow
									text="Direct Voxer/WhatsApp (60 days)"
									className="pt-[7px] pb-[7px]"
								/>
...
function MobileTierPair({ label, value }: { label: string; value: string }) {
	return (
		<div className="py-6">
			<p className="font-lato font-normal text-body text-[#41444E] leading-[140%]">
				{label}
			</p>
			<p className="mt-0 font-lato font-bold text-[22px] text-[#41444E] leading-[140%]">
				{value}
			</p>
		</div>
	);
...
function MobileTierCard({
	...
	return (
		<div className="relative rounded-[28px] bg-brand-white shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] px-6 pt-10 pb-6">
			...
			<h3 className="font-canela font-thin text-[42px] text-brand-black leading-[100%]">
				{title}
			</h3>
			...
			<p className="mt-6 font-lato font-normal text-[24px] text-[#41444E]">
				Investment
			</p>

			<p className="mt-[18px] font-canela font-normal text-[48px] leading-[100%] text-brand-deep">
				{price}
			</p>
