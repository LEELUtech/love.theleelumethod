...
export default function DecodedLoveCohortSection() {
	...
	return (
		<>
			<section className="relative py-16 pb-[150px] lg:pb-[100px] lg:py-24 bg-[#F3E0E1]">
				{/* Background */}
				...
				<div className="container relative px-4 mx-auto">
					...
					<div className="lg:mt-[112px] mt-[50px] text-center">
						<p className=" mb-[56px] md:mb-[80px] font-canela font-light text-brand-deep text-[32px] leading-[36px] max-w-[884px] mx-auto">
							Also: Discover the 3 secrets to choosing the right partner,
							creating healthy connection, and ending the cycle of
							disappointment.
						</p>
