...
export default function LoveLevelsAnimatedBlock({ cards }: { cards: Card[] }) {
  ...
  return (
    <div>
      ...
      <motion.div
        ref={headerRef}
        className="relative text-center mb-12 md:mb-16 lg:mb-[34px]"
        style={{ y: headerY }}
      >
        <div
          className="
        ...
        {cards.map((card, i) => (
          <motion.div
            ...
            className="
              ...
              w-full max-w-[361px] min-h-[497px] p-1
              md:max-w-[600px] md:min-h-[320px] md:p-8
              lg:max-w-none lg:w-[904px] lg:h-[449px] lg:p-10
            "
          >
            {card.img && (
            ...
            <h4
              className="
                ...
                text-[48px] md:text-[40px] lg:text-[60px]
              "
            >
              {card.title}
            </h4>
            ...
            <p
              className="
                ...
                text-[17px] md:text-[17px] lg:text-[18px]
              "
            >
              {card.text}
            </p>
