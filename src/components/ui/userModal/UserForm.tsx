...
export const UserForm = ({ onSuccess, onSubmit }: UserFormProps) => {
  const [form, handleChange] = useCustomForm();
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-pink-600 mb-8 text-center tracking-tight drop-shadow-lg">Join the Program</h2>
