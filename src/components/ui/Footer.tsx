			...
			<div className="container">
				<div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-10 lg:gap-0">
					...
					<div className="order-1 lg:order-1">
						<div className="flex flex-col lg:flex-row lg:items-start lg:gap-5 mb-4 lg:mb-0">
							<span className="inline-block w-[57px] h-[57px] md:w-12 md:h-12 relative mb-[12px] lg:mb-0">
								<Image
									src="/leelu_logo.svg"
